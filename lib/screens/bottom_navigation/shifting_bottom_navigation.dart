...
class ShiftingBottomNavigation extends StatefulWidget {
  ...
  @override
  State<ShiftingBottomNavigation> createState() =>
      _ShiftingBottomNavigationState();
}

class _ShiftingBottomNavigationState extends State<ShiftingBottomNavigation>
    with TickerProviderStateMixin<ShiftingBottomNavigation> {
  int currentIndex = 0;
